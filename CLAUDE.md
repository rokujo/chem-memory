...
- 「無機=青系、有機=緑系、理論=オレンジ系」で視覚的に分野を区別(※炎色反応のみ例外で赤系 — 炎のイメージを優先)
...
| 錯イオン形成 | 表型 | 本実装完了(コンテンツ要レビュー) | `/complex-ion` | 青 |
| 炎色反応 | 表型 | 本実装完了(コンテンツ要レビュー) | `/flame` | 赤(例外) |
| **電気分解** | 表型 | **本実装完了** | `/electrolysis` | オレンジ |
| **金属イオンの価数** | 表型 | **本実装完了** | `/ion-valence` | オレンジ |
